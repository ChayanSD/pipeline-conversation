      ...
      <div className="">
        ...
        <div className="flex justify-center items-center h-[80vh]">
          <div className="flex flex-col justify-center items-center">
            ...
            <button
              onClick={() => (window.location.href = "/create-audit")}
              className="bg-[#F7AF41] w-[318px] mt-4 h-[50px] hover:bg-yellow-600 text-black font-medium transition-colors font-acumin cursor-pointer rounded-full"
              style={{
