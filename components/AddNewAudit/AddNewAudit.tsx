    ...
    <div className="">
      <header className="">
        <div className=" flex items-center justify-center gap-2.5 max-w-7xl mx-auto ">
          <p>GRADING SCALE (1-5)</p>
          <div className="grid grid-cols-3 gap-[1.89px]">
            <p className="w-full text-[17px] font-medium bg-[#F65355] px-[38px] py-[10px] text-white rounded-tl-xl">
              1-2 URGENT ATTEN
            </p>
            <p className="w-full text-[17px] font-medium bg-[#F7AF41] px-[38px] py-[10px] text-white ">
              3-4 AVERAGE AUDIT
            </p>
            <p className="w-full text-[17px] font-medium bg-[#209150] px-[38px] py-[10px] text-white rounded-tr-xl">
              5 EXELLENT AUDIT
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="px-24 flex items-center justify-between">
            {["questions", "answers", "score"].map((item) => (
              <div key={item}>
                <p className="text-[22px] text-white capitalize font-500 tracking-[0.352px] leading-normal font-medium">
                  {item}
                </p>
              </div>
            ))}
      ...
      <main className="px-24 mt-5">
        <div className="flex gap items-center justify-between">
          <div className="flex-1">
            <input type="text" placeholder="Presntaton Name" className="w-full bg-[#4569871A]  text-[22px] px-8 py-[18px] border border-[#3b5163] rounded-[12px] outline-none tracking-[0.352px] leading-normal" />
          </div>
